...
const http = axios.create({ baseURL: 'http://localhost:8000/bill' })
...
export const getMonths = () => http.get('/months')
export const getCustomers = () => http.get('/customers')
...
export const payRecord = (id) => http.put(`/pay/${id}`)
